...
import { getSavedWaypoints, Waypoint } from '../services/db';
  ...
  return (
    ...
    >
      <div>
        ...
        {isLoading && <p className="p-4 text-center text-[#0d141c]">Loading waypoints...</p>}
        {error && <p className="p-4 text-center text-red-500">{error}</p>}

        {!isLoading && !error && waypoints.length === 0 && (
          <p className="p-4 text-center text-[#49739c]">No waypoints saved yet.</p>
        )}

        {!isLoading && !error && waypoints.length > 0 && (
          <div className="overflow-y-auto"> {/* Added for scrollability if list is long */}
            {waypoints.map((waypoint) => (
              <div key={waypoint.id} className="flex items-center gap-4 bg-slate-50 px-4 min-h-[72px] py-3 border-b border-slate-200 last:border-b-0">
                <div
                ...
                <div className="flex flex-col justify-center flex-grow overflow-hidden">
                  ...
                  <p
                    className="text-gray-500 text-xs font-normal leading-normal"
                  >
      ...
      <div className="mt-auto"> {/* Ensures buttons are at the bottom */}
        <div className="flex justify-end overflow-hidden px-5 pb-5 pt-2"> {/* Added pt-2 for some spacing */}
          <button
